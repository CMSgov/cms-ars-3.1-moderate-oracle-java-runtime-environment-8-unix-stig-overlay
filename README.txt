...
Java Runtime Environment (JRE) 8 on UNIX against
[DISA's](https://iase.disa.mil/stigs/Pages/index.aspx) Oracle JRE 8 UNIX
STIG Version 1 Release 3 tailored for [CMS ARS
...
[issue](https://github.cms.gov/ispg/cms-ars-3.1-moderate-oracle-java-runtime-environment-8-unix-stig-overlay/issues/new).
